...
class ViewController: UIViewController, UISearchBarDelegate {
    ...
    func urlWithComponents(cityName: String) -> URL? {
        
        let urlComponents = NSURLComponents()
        urlComponents.scheme = "http";
        urlComponents.host = "api.apixu.com"
        urlComponents.path = "/v1/current.json"
        
        let key = URLQueryItem(name: "key", value: "379d278a34c84eac97e182514172801")
        let city = URLQueryItem(name: "q", value: cityName)
        urlComponents.queryItems = [key, city]
    ...
    func searchBarSearchButtonClicked(_ searchBar: UISearchBar) {
        ...
        if let url = urlWithComponents(cityName: searchBar.text!) {
